...
<?php include "menu.php"?>
    ...
    $req = "SELECT c.car_name, rc.rent_start_date, rc.rent_end_date, rc.id FROM rentedcars rc, cars c WHERE rc.customer_username='chaimaD' AND c.car_id=rc.car_id AND rc.return_status='NR'AND rc.rent_start_date <= CURDATE(); ";
